...
public class TreasuryRatioRepository {
    ...
    public TreasuryRatioSnapshot insert(
            ...
            BigDecimal returnOnEquity, BigDecimal nonPerformingLoanRatio, BigDecimal loanToDepositRatio,
        ...
        var record = dsl.insertInto(RATIO_SNAPSHOTS)
                ...
                .set(RATIO_SNAPSHOTS.NON_PERFORMING_LOAN_RATIO, nonPerformingLoanRatio)
    ...
    private static TreasuryRatioSnapshot toSnapshot(
        ...
        return new TreasuryRatioSnapshot(
                ...
                record.getNonPerformingLoanRatio(),
                record.getCreatedAt());
    }
}
